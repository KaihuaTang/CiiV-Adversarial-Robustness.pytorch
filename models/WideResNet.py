...
class WideResNet(Base_Model):
    def __init__(self, depth=34, num_classes=10, widen_factor=10, dropRate=0.0, activation='ReLU', softplus_beta=1):
...
def create_model(m_type='WRN34-10', num_classes=1000, activation='ReLU', softplus_beta=1.0):
    if m_type == 'WRN34-10':
        model = WideResNet(34, num_classes, widen_factor=10, dropRate=0.0, activation=activation, softplus_beta=softplus_beta)
    else:
