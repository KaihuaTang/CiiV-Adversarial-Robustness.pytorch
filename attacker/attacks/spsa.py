...
class SPSA(Attacker):
    ...
    """
    def __init__(self, model, logger, config, delta=0.01, batch_size=128, steps=5, lr=0.01):
        ...
        logger.info('Create Attacker SPSA with delta: {}, steps: {}, lr: {}, batch_size: {}'.format(delta, steps, lr, batch_size))
    ...
    def forward(self, images, labels, random_start=False, targeted=False):
        ...
        for _ in range(self.steps):
            ...
            dx = torch.clamp(adv_images - images, min=-self.delta, max=self.delta)
