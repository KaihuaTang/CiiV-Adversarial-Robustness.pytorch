...
class UN(Attacker):
    ...
    """
    def __init__(self, model, logger, config, sigma=0.1):
    ...
    def forward(self, images, labels, random_start=False):
        """
        Overridden.
        """
        images = images.cuda()
        adv_images = images + self.sigma * torch.randn_like(images).uniform_(-1,1)
